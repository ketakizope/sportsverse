...
SECRET_KEY = "django-insecure-wi!)#lstspgyvym#yl3f=1mq69483dt7j@gepi5*jp_-szeiwe"
...
# Media files (for user-uploaded content like academy logos, resumes, videos, diet plans)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # Files will be stored in sportsverse/backend/media/
...
# Custom User Model
AUTH_USER_MODEL = 'accounts.CustomUser' # This is crucial!

# Django REST Framework settings
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',
        'rest_framework.authentication.SessionAuthentication', # Optional, for Django Admin login via browser
    ],
